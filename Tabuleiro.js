...
Tabuleiro.matrizAvaliacao = new Array(
	new Array(100,10,10,10,10,10,10,100),
	new Array(10,1,1,1,1,1,1,10),
	new Array(10,1,1,1,1,1,1,10),
	new Array(10,1,1,1,1,1,1,10),
	new Array(10,1,1,1,1,1,1,10),
	new Array(10,1,1,1,1,1,1,10),
...
Tabuleiro.avaliar = function (triplas) {
	var soma = 0;
	var x, y;
	for (var i = 0; i < triplas.length; i++)
		if (triplas[i][2] == 0){
			x = triplas[i][0];
			y = triplas[i][1];
			soma += Tabuleiro.matrizAvaliacao[x][y];
		}
	return soma;
}
